...
// =============================================================================
// check — helper to create a named check result
// =============================================================================
function check(pass, label, hint, weight = 1) {
  return { pass: !!pass, label, hint, weight };
}
...
export function scoreSEO({
  ...
  // ==================================================================
  // Run all checks — each returns { pass, label, hint, weight }
  // ==================================================================
  const checks = [
    // Title checks
    check(
