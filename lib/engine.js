...
// Load WebLLM from the bundled vendor file. The CDN approach was removed
// because newer CDN versions have breaking API changes and model format
// mismatches (e.g. "Cannot read image.png" errors).
